...
.posts-grid .post-card:nth-child(1) { animation-delay: 0ms; }
.posts-grid .post-card:nth-child(2) { animation-delay: 100ms; }
.posts-grid .post-card:nth-child(3) { animation-delay: 200ms; }
.posts-grid .post-card:nth-child(4) { animation-delay: 300ms; }
.posts-grid .post-card:nth-child(5) { animation-delay: 400ms; }
.posts-grid .post-card:nth-child(6) { animation-delay: 500ms; }
...
| CSS 文件增量 | `wc -c assets/css/style.css` | < 5KB (gzip) |
